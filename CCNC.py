...
import os
import glob
import pickle       # all code that uses this is commented out
...
def main():
    ...
    parser.add_argument("-res", "--output_time_resolution", help="time  \
                                resolution of output data. Default 1 second", default='1S')
...
def ss_cal(ccn_data, atmos_press=1010, cal_press=830):
    ...
    if cal_press == None:
        ...
        print("Assumed most recent calibration for the instrument was done in \
              Boulder and so I've used 830 mbar as calibration pressure for \
              supersaturation calibration")
